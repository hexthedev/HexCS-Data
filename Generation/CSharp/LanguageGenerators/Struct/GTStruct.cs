...
namespace HexCS.Data.Generation.CSharp
{
    ...
    /// </summary>
    public class GTStruct : AInheritableGenerator, IStruct, INamespaceObject
    {
        ...
        public GTStruct(StringBuilder output) : base(output)
        {
        }
        ...
        public override void Generate()
        {
            ...
            OutputBuilder.AppendLine($"{IndentProvider.IndentString}{Keywords.ToKeywordString()}struct {Name}{GenericTypes.ToGenericTypeString()}{Inheritances.ToInheritanceString()}");
